...
QHBoxLayout* AdminWidget::createButtonsForManagingDogs()
{
	...
	buttons->addWidget(this->displayPlotButton);
...
void AdminWidget::connectSignalsAndSlots()
{
	...
	QObject::connect(this->undoShortcut, &QShortcut::activated, this, &AdminWidget::undoAction);
	QObject::connect(this->redoShortcut, &QShortcut::activated, this, &AdminWidget::redoAction);
