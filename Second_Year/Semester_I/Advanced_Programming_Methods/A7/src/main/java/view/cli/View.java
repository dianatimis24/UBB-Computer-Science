...
public class View {
    ...
    private static IStatement createExampleWithTypeError() {
        // bool a; int b; b = a + 5;
        return new CompoundStatement(
                new VariableDeclarationStatement("a", new BoolType()),
                new CompoundStatement(
    ...
    public static void main() {
        ...
        try {
            ...
            menu.addCommand(new RunExampleCommand("11", createExample11(), createController(createExample11(), "log11.txt")));
            // menu.addCommand(new RunExampleCommand("12", createExampleWithTypeError(), createController(createExampleWithTypeError(), "log12.txt")));
        }
        catch (MyException e) {
            System.out.println("An error occurred during the initialization of the program: " + e.getMessage());
            System.exit(1);
        }
